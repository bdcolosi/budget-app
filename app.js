...
let UIController = (function () {
  ...
  return {
    ...
    addListIem: function (obj, type) {
      ...
      //insert the html into the dom using insertAdjecent html METHOD.
    ...
    //clearing fields input and value
...
let controller = (function (budgetCtrl, UICtrl) {
  ...
  let ctrlAddItem = function () {
    let input, newItem;
    //get feild input data

    input = UIController.getInput();

    if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
      //add item to budget ctrler
      ...
      //add new item to UI
      UIController.addListIem(newItem, input.type);
      // clear the fields
